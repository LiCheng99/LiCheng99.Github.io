const anzhiyu = {
  ...
  snackbarShow: (text, showAction = false, duration = 2000) => {
    ...
    root.style.setProperty("--licheng-snackbar-time", duration + "ms");
  ...
  initThemeColor: function () {
    let themeColor = getComputedStyle(document.documentElement)
      .getPropertyValue("--licheng-bar-background")
      .trim()
      .replace('"', "")
      .replace('"', "");
    ...
    if (currentTop > 56) {
      if (anzhiyu.is_Post()) {
        themeColor = getComputedStyle(document.documentElement)
          .getPropertyValue("--licheng-meta-theme-post-color")
          .trim()
          .replace('"', "")
          .replace('"', "");
      }
  ...
  getCustomPlayList: function () {
    ...
    if (urlParams.get("id") && urlParams.get("server")) {
      ...
      anMusicPageMeting.innerHTML = `<meting-js id="${id}" server=${server} type="playlist" type="playlist" mutex="true" preload="auto" theme="var(--licheng-main)" order="list" list-max-height="calc(100vh - 169px)!important"></meting-js>`;
    } else {
      anMusicPageMeting.innerHTML = `<meting-js id="${userId}" server="${userServer}" type="playlist" mutex="true" preload="auto" theme="var(--licheng-main)" order="list" list-max-height="calc(100vh - 169px)!important"></meting-js>`;
    }
